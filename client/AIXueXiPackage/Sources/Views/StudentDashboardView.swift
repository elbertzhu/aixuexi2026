    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 0) {
                ...
                .padding()
                .onChange(of: api.currentUserId) { _, newValue in
    ...
    var body: some View {
        NavigationView {
                ...
                Section("输入邀请码") {
                    HStack {
                        TextField("6位邀请码", text: $code)
                            ...
                            #endif
                            .font(.system(size: 20, weight: Font.Weight.bold, design: .monospaced))
            ...
            .onAppear {
                ...
                if let pasted = readPasteboardString(), pasted.count == 6 {
    ...
    func load() {
        ...
        Task {
            do {
                ...
                _ = try await api.getTeacherDashboard()
                self.joinedClasses = []
